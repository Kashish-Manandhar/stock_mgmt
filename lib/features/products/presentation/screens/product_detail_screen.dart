...
//       appBar: AppBar(
//        actions: [
//          IconButton(onPressed: () => context.router.navigate(
//            AddProductsRoute(
//              product: product
//            )
...
//             ...availableAlphaSizes.map((availableSize) {
//               if (product.availableSizeWithQuantity
//                   .containsKey(availableSize)) {
//                 return Row(
//                   children: [
//                     Text('${_getString(availableSize)} : '),
//                     Text(product.availableSizeWithQuantity[availableSize]
//                         .toString()),
//                   ],
//                 );
//               } else {
