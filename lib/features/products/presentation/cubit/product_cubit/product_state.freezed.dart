...
class _$ProductStateImpl implements _ProductState {
  const _$ProductStateImpl(
      {this.productResponseModel = const ProductResponseModel(),
  ...
  @override
  String toString() {
    return 'ProductState(productResponseModel: $productResponseModel, isLoading: $isLoading, isMoreLoading: $isMoreLoading, errorMessage: $errorMessage)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, productResponseModel, isLoading,
      isMoreLoading, errorMessage);
